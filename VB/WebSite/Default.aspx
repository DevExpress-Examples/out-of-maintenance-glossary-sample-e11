...
<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="ASPxperience_GlossarySample" %>
...
<%@ Register Assembly="DevExpress.Web.v7.3" Namespace="DevExpress.Web.ASPxCallbackPanel"
	TagPrefix="dxcp" %>
<%@ Register Assembly="DevExpress.Web.v7.3" Namespace="DevExpress.Web.ASPxRoundPanel"
	TagPrefix="dxrp" %>

<%@ Register Assembly="DevExpress.Web.v7.3" Namespace="DevExpress.Web.ASPxPopupControl"
	TagPrefix="dxpc" %>
